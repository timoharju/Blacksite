...
public class ConsoleInput {
    ...
    private CanvasGroup canvasgroup;    //the canvas, inputfield should be a child
    ...
    public ConsoleInput(InputField inputfield, CanvasGroup canvasgroup, Button consoleButton, LightsoffGame ligtsoffGame, Pipegame pipegame)
    {
    ...
    private void command(string command)
    {
        ...
        //add commands with if statements
        ...
        //enable godmode which doesnt even exist
